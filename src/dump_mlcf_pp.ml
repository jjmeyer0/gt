...
let rec dump_mlcf_pp (g:Grammar.grammar) = 
...
os ("\nlet pp (os:string->unit) (to_pretty_print:bool) e = pp_" ^ symbol_var_name (Grammar.get_start_symbol g) ^ " os to_pretty_print e;;");
close_out ofile;;
